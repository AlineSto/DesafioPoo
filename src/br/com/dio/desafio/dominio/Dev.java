...
public class Dev {
    ...
    public void InscreverBootcamp( Bootcamp bootcamp){
     ...
     bootcamp.getDevsInscritos().add(this);// o dev esta inscritos no conteudo inscritos acima
    }

    public void progredir(){
    Optional<Conteudo> conteudo = this.conteudosInscritos.stream().findFirst();// a ordem que os cursos foram inscritos na plataforma
    if (conteudo.isPresent()){
        this.conteudosConcluidos.add(conteudo.get());
        this.conteudosInscritos.remove(conteudo.get());
    }else{ // apresenta erro caso não esteja incristo
        System.err.println(" voce não esta matriculado em nenhum curso");
    }
